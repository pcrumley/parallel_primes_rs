...
fn main() -> Result<()> {
    ...
    let matches = App::new("Parallel Primes")
                          ...
                          .about("This is a parallelized Rust program where you can pass it two integers and it will print a vector of all of the primes between the two integers (inclusive) to standard out. It is parallelized and you can change the number of threads with the -N option")
                          .arg(Arg::with_name("THREADS")
                               .short("N")
                               .long("Nthreads")
                               .value_name("NTHREADS")
                               .help("Sets the number of threads. If not supplied it will set the number of threads equal to the number of cpu cores.")
                               .takes_value(true))
                          .arg(Arg::with_name("START")
                               .help("The number start looking for primes")
                               .required(true)
                               .index(1))
                          .arg(Arg::with_name("STOP")
                                .help("The number to stop looking for primes")
                                .required(true)
                                .index(2))
                          .get_matches();
